...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            String uuid = BluetoothAdapter.getDefaultAdapter().getAddress();
            if( HttpUtil.makeUser(mUsername,mEmail,mPassword,uuid)!=-1){
                SharedPreferences sp = LoginActivity.this.getSharedPreferences("data",MODE_PRIVATE);
                sp.edit().putString("name",mUsername).commit();
                return true;
            }
